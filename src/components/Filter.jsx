...
const Filter = ({activeCategory,setActiveCategory, activePrice, setActivePrice,products, setFilters}) => {
         ...
         <div>
            {
                categories.map(item =>(
                    ...
                    key={item.id}
                    className= {`bg-white border-2 border-gray-500  rounded-lg px-4 mr-2 py-2 m-2
                    ${activeCategory === item.name && 'bg-blue-700 text-white font-bold'}
                    `}> 
        ...
        <div>
            {
                prices.map(item =>(
                    ...
                    className= {`bg-white border-2 border-gray-500  rounded-lg px-4 mr-2 py-2 m-2
                    ${activePrice === item.value && 'bg-amber-700 text-white font-bold'}
                    `}> 
